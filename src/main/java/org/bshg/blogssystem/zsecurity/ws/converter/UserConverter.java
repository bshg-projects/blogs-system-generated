package org.bshg.blogssystem.zsecurity.ws.converter;
...
public class UserConverter extends AbstractConverter<User, UserDto> {
    ...
    public <T extends User, DTO extends UserDto> void convertToChildItem(DTO dto, T item) {
        User user = toItem(dto);
